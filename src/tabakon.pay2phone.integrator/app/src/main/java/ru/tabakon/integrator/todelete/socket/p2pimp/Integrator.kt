...
import ru.tabakon.integrator.host.p2p.IPayToPhoneClient
import ru.tabakon.integrator.host.p2p.P2pResult
import ru.tabakon.integrator.host.p2p.PayToPhoneClient
import ru.tabakon.integrator.log
import ru.tabakon.integrator.todelete.socket.http.TabakonHttpClientBuilder
import java.net.URI
