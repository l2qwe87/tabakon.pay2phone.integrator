package ru.tabakon.integrator.activities.ui.screens
        ...
        Row {
            Button(
                onClick = {
                    ...
                    IntegrationWorker.startService(MainApplication.applicationContext(), "${tabakonWebSocketViewModel.host}:${tabakonWebSocketViewModel.port}")
                },
