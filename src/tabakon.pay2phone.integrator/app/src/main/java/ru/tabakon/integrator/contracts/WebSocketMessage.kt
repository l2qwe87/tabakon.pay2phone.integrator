...
data class OrderStatusChanged(val orderId: String?, val orderStatus: OrderStatusEnum, val description: String? = null):
    IMessageBody
...
@Serializable
data class CreatePaymentOrderCommand(val orderId: String, val paymentMethod: String?, val amount: Float?):
    IMessageBody
